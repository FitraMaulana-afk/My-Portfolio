...
export const Details = ({ postion, company, companyLink, time, address, work }) => {
    ...
    return <li ref={ref} className="my-8 first:mt-0 last:mb-0 w-[60%] mx-auto flex flex-col items-center justify-between md:w-[80%]">
        ...
        >
            <h3 className="capitalize font-bold text-2xl sm:text-xl xs:text-lg">{postion}&nbsp;<a
        ...
        <div className="my-64">
            ...
            <div ref={ref} className="w-[75%] mx-auto relative lg:w-[90%] md:w-full">
                ...
                <ul className="w-full flex flex-col items-start justify-between ml-4 xs:ml-2">
                    ...
                    />
                    <Details
                        postion="Intern " company="@Facebook"
                    ...
                    />
                    <Details
                        postion="Software Developer   " company="@Amazon"
                    ...
                    />
                    <Details
                        postion="Software Developer Intern" company="@Microsoft"
                    ...
                    />
                    <Details
                        postion="Teaching Assistant" company="@MIT"
